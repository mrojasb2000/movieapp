...
type Registry interface {
	...
	// ServiceAddresses returns the list de addesses of active services of the given service.
...
// GenerateInstanceID generates a pseudo-ramdom service instance identifier, using
// a service name suffixed by dash and a random number.
